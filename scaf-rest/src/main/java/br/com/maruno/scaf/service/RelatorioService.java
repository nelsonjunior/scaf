...
import br.com.maruno.scaf.persistence.VWRelatorioDao;
...
public class RelatorioService {
	...
	public Map<String, Object> findRelatorio(){   
		...
		mapa.put(LISTA, relatorioDao.findByCodUsuario(tokenService.getCodUsuario()));
	...
	public Map<String, Object> findRelatorioAgrupado(){
		...
		List<VWRelatorio> lista = relatorioDao.findByCodUsuario(tokenService.getCodUsuario());  
